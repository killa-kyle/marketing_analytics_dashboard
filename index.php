...
<div class="container-fluid">
    <table class="channels-table table table-striped table-bordered table-condensed dash-element" id="channels">    
        <thead class="thead-inverse">
            <tr>
                <th>Channel</th>
                <th>This Week <div class="this-week-date-header"></div> <span>(sessions | conversions | rate) </span></th>
                <th>Last Week <span>(sessions | conversions | rate) </span></th>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <h3 class="text-center dash-element-header">Top Active Pages</h3>
              <div class="list-group active-pages ">
